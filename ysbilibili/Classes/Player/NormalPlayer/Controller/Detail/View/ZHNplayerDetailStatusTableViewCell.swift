...
class ZHNplayerDetailStatusTableViewCell: YSBaseLineCell {
    ...
    override func awakeFromNib() {
        ...
        // 2. 按钮图片的初始化
        shareButton.setBackgroundImage(UIImage(named: "iphonevideoinfo_share")?.ysTintColor(kshareColor), for: .normal)
        shareButton.setBackgroundImage(UIImage(named: "iphonevideoinfo_share")?.ysTintColor(kshareColor), for: .highlighted)
        sendCoinButton.setBackgroundImage(UIImage(named: "iphonevideoinfo_bp")?.ysTintColor(kcoinColor), for: .normal)
        sendCoinButton.setBackgroundImage(UIImage(named: "iphonevideoinfo_bp")?.ysTintColor(kcoinColor), for: .highlighted)
        collectButton.setBackgroundImage(UIImage(named: "iphonevideoinfo_fav")?.ysTintColor(kcollectColor), for: .normal)
        collectButton.setBackgroundImage(UIImage(named: "iphonevideoinfo_fav")?.ysTintColor(kcollectColor), for: .highlighted)
        downLoadButton.setBackgroundImage(UIImage(named: "iphonevideoinfo_dl")?.ysTintColor(kdownloadColor), for: .normal)
        downLoadButton.setBackgroundImage(UIImage(named: "iphonevideoinfo_dl")?.ysTintColor(kdownloadColor), for: .highlighted)
        // 3. icon图片的初始化
        playCountImageView.image = UIImage(named: "misc_playCount_new")?.ysTintColor(UIColor.lightGray)
        danmuImageView.image = UIImage(named: "misc_danmakuCount_new")?.ysTintColor(UIColor.lightGray)
        // 4. 自身属性的初始化
...
//        print(descLabel.getLastLinePosition())
    }
