...
class ZHNnormalPlayWindowMenuVIew: ZHNlivePlayNoramlMenuView {
    ...
    lazy var seekTimeSlider: playCustomSlider = {
        ...
        seekTimeSlider.minimumTrackTintColor = kNavBarColor
    ...
    lazy var seekedTimeProgress: UIProgressView = {
        ...
        seekedTimeProgress.progressTintColor = UIColor.ysColor(red: 188, green: 122, blue: 141, alpha: 1)
    ...
    lazy var currentMarkProgressView: UIProgressView = {
        ...
        currentMarkProgressView.progressTintColor = kNavBarColor
