...
extension ZHNhomePageViewModel {
    ...
    func requestData(mid: Int,finishAction:@escaping (()->Void)) {
        ...
        YSNetworkTool.shared.requestData(.get, URLString: "http://app.bilibili.com/x/v2/space?build=3970&device=phone&mobi_app=1&platform=ios&vmid=\(mid)", finished: { (result) in
