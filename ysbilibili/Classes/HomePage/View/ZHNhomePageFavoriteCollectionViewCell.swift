        ...
        didSet {
            ...
            if count == 1 {
                ...
                for i in 0..<2 {
                    ...
                    coverImageView.backgroundColor = UIColor.lightGray
                    self.addSubview(coverImageView)
                    let coverImageY = (self.ysHeight/2 + 2.5) * CGFloat(i)
                    let height = (self.ysHeight/2 - 2.5)
                    coverImageView.frame = CGRect(x: 0, y: coverImageY, width: self.ysWidth, height: height)
                    // 2. 赋值图片
                ...
                for i in 0..<3 {
                    ...
                    let height = (self.ysHeight/2 - 2.5)
                    if i == 0 {
                        coverImageView.frame = CGRect(x: 0, y: 0, width: self.ysWidth, height: height)
                    }else {
                        let coverImageY = (self.ysHeight/2 + 2.5)
                        let coverImageX = (self.ysWidth/2 + 2.5) * CGFloat(i - 1)
                        let coverImageWidth = (self.ysWidth/2 - 2.5)
...
extension ZHNhomePageFavoriteCollectionViewCell {
    fileprivate func setupUI() {
        ...
        countLabel.backgroundColor = UIColor.ysColor(red: 80, green: 80, blue: 80, alpha: 0.7)
