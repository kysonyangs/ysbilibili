...
class ZHNhomePageArchiveCollectionViewCell: YSNormalBaseCell {
 
    override var statusModel: YSItemDetailModel? {
        didSet {
            intialStatus()
    ...
    lazy var playIconImageView: UIImageView = {
        ...
        playIconImageView.image = UIImage(named: "misc_playCount_new")?.ysTintColor( UIColor.lightGray)
    ...
    lazy var danmukuIconImageView: UIImageView = {
        ...
        danmukuIconImageView.image = UIImage(named: "misc_danmakuCount_new")?.ysTintColor( UIColor.lightGray)
