...
class YSCommendTableViewCell: UITableViewCell {
    ...
    var commendModel: YSPlayCommendModel? {
        didSet {
            //1. 加载数据
            initStatus()
        }
    ...
    lazy var headImageView: UIImageView = {
        ...
        headImageView.ysCornerRadius = 15
    ...
    lazy var replyCoutIcon: UIImageView = {
        ...
        replyCoutIcon.image = UIImage(named: "circle_reply_ic")?.ysTintColor(kNavBarColor)
    ...
    lazy var contentLabel: WTKAutoHighLightLabel = {
        ...
        contentLabel.w_highColor = kNavBarColor
        contentLabel.w_normalColor = UIColor.ysColor(red: 25, green: 25, blue: 25, alpha: 1)
    ...
    //初始化方法
    class func commendCell(tableView: UITableView) -> YSCommendTableViewCell {
        var cell = tableView.dequeueReusableCell(withIdentifier: "YSCommendTableViewCell")
        if cell == nil {
            cell = YSCommendTableViewCell(style: .default, reuseIdentifier: "YSCommendTableViewCell")
        }
        return cell as! YSCommendTableViewCell
    }
}

// MARK - 私有方法
extension YSCommendTableViewCell {
    func initStatus() {
        // 1.加载头像
...
//            contentLabel.text = content
    ...
    fileprivate func addUI() {
        ...
        let tap = UITapGestureRecognizer { [weak self] in
            ...
            YSNotificationHelper.recommendSelectedHomePage(mid: mid)
        }
