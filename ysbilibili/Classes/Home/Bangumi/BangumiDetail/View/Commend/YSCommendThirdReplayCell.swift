...
class YSCommendThirdReplayCell: YSCommendTwoReplayCell {
    ...
    lazy var thirdSecContentLabel: WTKAutoHighLightLabel = {
        ...
        thirdSecContentLabel.w_highColor = kNavBarColor
...
//            thirdSecContentLabel.text = content
    ...
    //初始化方法
    class func thirdSecCommendCell(tableView: UITableView) -> YSCommendThirdReplayCell {
        var cell = tableView.dequeueReusableCell(withIdentifier: "YSCommendThirdReplayCell")
        if cell == nil {
            cell = YSCommendThirdReplayCell(style: .default, reuseIdentifier: "YSCommendThirdReplayCell")
        }
        return cell as! YSCommendThirdReplayCell
    }
