...
class YSCommendTwoReplayCell: YSCommendTableViewCell {
    ...
    lazy var twoSecContentLabel: WTKAutoHighLightLabel = {
        ...
        twoSecContentLabel.w_highColor = kNavBarColor  
...
//            twoSecContentLabel.text = content 
    ...
    //初始化方法
    class func towSecCommendCell(tableView: UITableView) -> YSCommendTwoReplayCell {
        var cell = tableView.dequeueReusableCell(withIdentifier: "YSCommendTwoReplayCell")
        if cell == nil {
            cell = YSCommendTwoReplayCell(style: .default, reuseIdentifier: "YSCommendTwoReplayCell")
        }
        return cell as! YSCommendTwoReplayCell
    }
}
