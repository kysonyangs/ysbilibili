...
class YSCommendFourReplayCell: YSCommendThirdReplayCell {

    lazy var fourSeclineView: UIView = {
        let fourSeclineView = UIView()
        fourSeclineView.backgroundColor = kCellLineGrayColor
    ...
    lazy var fourSecContentLabel: WTKAutoHighLightLabel = {
        ...
        fourSecContentLabel.w_highColor = kNavBarColor
    ...
    lazy var allStatusLabel: UILabel = {
        ...
        allStatusLabel.textColor = kNavBarColor
...
//            fourSecContentLabel.text = content
    ...
    //初始化方法
    class func fourSecCommendCell(tableView: UITableView) -> YSCommendFourReplayCell {
        var cell = tableView.dequeueReusableCell(withIdentifier: "YSCommendFourReplayCell")
        if cell == nil {
            cell = YSCommendFourReplayCell(style: .default, reuseIdentifier: "YSCommendFourReplayCell")
        }
        return cell as! YSCommendFourReplayCell
    }
