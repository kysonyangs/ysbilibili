//
//  YSBangumiDetailHeaderView.swift
//  ysbilibili
//
...
class YSBangumiDetailHeaderView: UIView {

    var headDetailModel: YSBangumiDetailModel? {
        didSet {
            // 加载背景和海报
    ...
    fileprivate lazy var characterView: YSBangumiDetailHeadCharacterView = {
        let characterView = YSBangumiDetailHeadCharacterView.instanceView()
        return characterView
    }()
    
    fileprivate lazy var menuView: YSBangumiDetailHeadMenuView = {
        let menuView = YSBangumiDetailHeadMenuView.instanceView()
        return menuView
    }()
...
// MARK:- target action
//======================================================================
extension YSBangumiDetailHeaderView {
