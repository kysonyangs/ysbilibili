...
@objc protocol YSCarouselViewDelegate {
    @objc optional func carouselViewSelectedIndex(index: Int)
}

class YSCarouselView: UIView {
    // MARK: - 代理
    weak var delegate: YSCarouselViewDelegate?
    ...
    override func layoutSubviews() {
        ...
        pageControl.currentPageIndicatorTintColor = kNavBarColor
...
extension YSCarouselView: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if let delegate = delegate {
            if let method = delegate.carouselViewSelectedIndex {
