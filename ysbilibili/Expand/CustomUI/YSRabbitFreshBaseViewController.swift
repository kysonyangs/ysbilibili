//
//  YSRabbitFreshBaseViewController.swift
//  ysbilibili
//
...
class YSRabbitFreshBaseViewController: UIViewController {
    // MARK: - 常量变量
    ...
    fileprivate lazy var leftRabbitEar: UIView = {[unowned self] in
        ...
        tempRabbitEar.backgroundColor = UIColor.ysColor(red: 241, green: 241, blue: 241, alpha: 1)
    ...
    fileprivate lazy var noticeLabel: UILabel = {
        ...
        noticeLabel.textColor = UIColor.ysColor(red: 244, green: 169, blue: 191, alpha: 1)
...
// MARK:- 私有方法
//========================================================================
extension YSRabbitFreshBaseViewController {
    ...
    fileprivate func setupUI() {
        ...
        firstSingleView.center = CGPoint(x: rabbitEarMaskView.ysCenterX, y: -20)
        ...
        secondSingleView.center = CGPoint(x: rabbitEarMaskView.ysCenterX, y: -20)
        ...
        gifImageView.center = CGPoint(x: rabbitEarMaskTopView.ysCenterX, y: 15)
        gifImageView.bounds = CGRect(x: 0, y: 0, width: 100, height: 40)
        
        rabbitEarMaskTopView.addSubview(gifNoticeLabel)
        gifNoticeLabel.center =  CGPoint(x: rabbitEarMaskTopView.ysCenterX, y: 35)
    ...
    fileprivate func creatAnimation(right:Bool) -> CAKeyframeAnimation{
        ...
        earAnimation.values = [delta*CGFloat(Float.pi / 2),delta*CGFloat(Float.pi / 4),delta*CGFloat(Float.pi / 2),delta*CGFloat(Float.pi / 4),delta*CGFloat(Float.pi / 2)]
...
extension YSRabbitFreshBaseViewController {
    override func observeValue(forKeyPath keyPath: String?, of object: Any?, change: [NSKeyValueChangeKey : Any]?, context: UnsafeMutableRawPointer?) {
        ...
        let rota = CGFloat(Float.pi / 2)*delta
...
//============================================================================
extension YSRabbitFreshBaseViewController : UIScrollViewDelegate {
...
// MARK:- 右滑返回的代理方法
//======================================================================
extension YSRabbitFreshBaseViewController: UIGestureRecognizerDelegate {
